...
parser = argparse.ArgumentParser(description='Run biofuel policy optimization model (nonnested_D2_RV2) with configurable input/output folders.')
...
for k in range(K_RANGE):    
    # Read input_biofuel from generated V2 (OLD rules, NC-zeroed CI columns)
    ...
    for break_idx, break_val in enumerate(breaks):
        ...
        #         conventionalfuel_quantity.loc[(conventionalfuel_quantity['F'] == 'G') | (conventionalfuel_quantity['F'] == 'D'), 'Q'].sum()/1.6)*1.6 / 
        #         (conventionalfuel_quantity.loc[(conventionalfuel_quantity['F'] == 'J'), 'Q'].sum()+conventionalfuel_quantity.loc[(conventionalfuel_quantity['F'] == 'G') | (conventionalfuel_quantity['F'] == 'D'), 'Q'].sum())
        #     )
        ...
        #     (input_compliance.loc[input_compliance['mandate'] == 'RF', 'Q'].item()*conventionalfuel_quantity.loc[(conventionalfuel_quantity['F'] == 'G') | (conventionalfuel_quantity['F'] == 'D'), 'Q'].sum()+3*1.6)/(conventionalfuel_quantity.loc[(conventionalfuel_quantity['F'] == 'J'), 'Q'].sum()+conventionalfuel_quantity.loc[(conventionalfuel_quantity['F'] == 'G') | (conventionalfuel_quantity['F'] == 'D'), 'Q'].sum())
        # )
       ...
       # Conventional fuel prices
        ...
        # Constraints.append(sum_SAF_biofuel_quantity - input_compliance.loc[input_compliance['mandate'] == 'SAF', 'Q'].item() <= PD2zeta * M11_0)
        ...
        Constraints.append(0 <= (biofuel_quantity.loc[(biofuel_quantity['D4'] == 1), 'Q'].sum() - 
                                (input_compliance.loc[input_compliance['mandate'] == 'BBD', 'Q'].item() / 1.6 * conventionalfuel_quantity.loc[conventionalfuel_quantity['F'].isin(['G', 'D']), 'Q'].sum())))
        Constraints.append((biofuel_quantity.loc[(biofuel_quantity['D4'] == 1), 'Q'].sum() - 
                            (input_compliance.loc[input_compliance['mandate'] == 'BBD', 'Q'].item() / 1.6 * conventionalfuel_quantity.loc[conventionalfuel_quantity['F'].isin(['G', 'D']), 'Q'].sum())) <= PD4zeta * M11_1)
        ...
        Constraints.append((sum(biofuel_quantity.loc[biofuel_quantity['f'] == 'B100', 'kappa_RFS'] * biofuel_quantity.loc[biofuel_quantity['f'] == 'B100', 'Q']) +
            ...
            sum(biofuel_quantity.loc[biofuel_quantity['f'] == 'SAF', 'kappa_RFS'] * biofuel_quantity.loc[biofuel_quantity['f'] == 'SAF', 'Q']) +
            sum(biofuel_quantity.loc[biofuel_quantity['f'] == 'gasE100', 'kappa_RFS'] * biofuel_quantity.loc[biofuel_quantity['f'] == 'gasE100', 'Q']) -
            (input_compliance.loc[input_compliance['mandate'] == 'RF', 'Q'].item()*conventionalfuel_quantity.loc[(conventionalfuel_quantity['F'] == 'G') | (conventionalfuel_quantity['F'] == 'D'), 'Q'].sum()+3*1.6)
        )>=0)
    ...
    if best_df is not None:
        ...
        if k == 0:
            append_to_excel(os.path.join(output_dir1, 'Mean.xlsx'), Intermediate_var, 'Nonnested_D2_RV2')

        if k == 1:
            append_to_excel(os.path.join(output_dir1, '10th.xlsx'), Intermediate_var, 'Nonnested_D2_RV2')

        if k == 2:
            append_to_excel(os.path.join(output_dir1, '33th.xlsx'), Intermediate_var, 'Nonnested_D2_RV2')

        if k == 3:
            append_to_excel(os.path.join(output_dir1, '67th.xlsx'), Intermediate_var, 'Nonnested_D2_RV2') 

        if k == 4:
            append_to_excel(os.path.join(output_dir1, '90th.xlsx'), Intermediate_var, 'Nonnested_D2_RV2')
...
append_to_excel(f'{output_dir}Solution.xlsx', solution, 'Nonnested_D2_RV2')
append_to_excel(f'{output_dir}Fitted_quantity.xlsx', Fitted_quantity, 'Nonnested_D2_RV2')
append_to_excel(f'{output_dir}Fuel_price.xlsx', Fuel_price, 'Nonnested_D2_RV2')
append_to_excel(f'{output_dir}Fuel_CI.xlsx', Fuel_CI, 'Nonnested_D2_RV2')
append_to_excel(f'{output_dir}Total.xlsx', Total, 'Nonnested_D2_RV2')
append_to_excel(f'{output_dir}Feedstock_source.xlsx', Feedstock_source, 'Nonnested_D2_RV2')
